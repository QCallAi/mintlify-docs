...
## Here are the steps to connect your AwazIndia account with Salesforce.
...
6. Complete the steps to connect your AwazIndia account with Salesforce.

Once you have completed these steps, your AwazIndia account will be integrated with Salesforce allowing you to sync data.
