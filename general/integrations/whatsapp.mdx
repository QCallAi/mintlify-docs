...
## Here are the steps to connect your AwazIndia account with WhatsApp.
...
To obtain both the WhatsApp Access Token and WhatsApp Business ID, please follow the process by clicking [here](https://docs.awazindia.ai/general/integrations/whatsappBusinessApiSetup).
