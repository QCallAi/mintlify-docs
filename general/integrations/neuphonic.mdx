---
title: Neuphonic
description: "Bring your Neuphonic voice capabilities to AwazIndia for lifelike conversations."
---
...
<ul>
    ...
    <li>Go to the Integrations tab within your AwazIndia account.</li>
...
<ul>
    ...
    <li>Navigate to Assistant Settings in your AwazIndia dashboard.</li>
    ...
    <li>If you’ve created custom voices on Neuphonic, you can link and use them directly within AwazIndia.</li>
...
Now your AwazIndia assistant will engage users with lifelike, emotionally rich voices, powered by Neuphonic's advanced AI speech synthesis.
