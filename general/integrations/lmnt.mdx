---
title: LMNT
description: "Bring your LMNT voice capabilities to AwazIndia for lifelike conversations."
---
...
<ul>
    ...
    <li>Now, head over to your AwazIndia dashboard, go to the Integrations section, and select LMNT.</li>

    <li>Paste the copied API key into the provided field and click Save to successfully link LMNT with AwazIndia.</li>

</ul>

## Configure LMNT Voice Settings in AwazIndia

<ul>

    <li>Navigate to Assistant Settings within your AwazIndia account.</li>
