...
1. Copy **OAuth Redirect URL** from AwazIndia to **Redirect URIs** field and add it.
...
1. Copy **App key** to **App key** field on AwazIndia.
1. Copy **App secret** to **App secret** field on AwazIndia.
