...
6. Copy **OAuth Redirect URL** from AwazIndia to **Redirect URI** field, and click on the **Create** button.
7. Copy the **Your Client ID** value to the `Client ID` field on AwazIndia.
8. Copy the **Your Client Secret** value to the `Client Secret` field on AwazIndia.
9. Click **Submit** button on AwazIndia.
