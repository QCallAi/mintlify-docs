...
6. Copy **OAuth Redirect URL** from AwazIndia to **Redirect URL(s)** field.
7. Copy **Client ID** to **Client ID** field on AwazIndia.
8. Copy **Client Secret** to **Client Secret** field on AwazIndia.
