...
<Info>
   This page explains the steps you need to follow to set up the Twilio connection in AwazIndia. If any of the steps are outdated, please let us know!
</Info>
...
3. Copy **Auth Token** and paste it to **Auth Token** field on the
   AwazIndia connection creation page.
4. Click **Submit** button on AwazIndia.
