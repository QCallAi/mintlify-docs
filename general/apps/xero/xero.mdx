...
5. Copy **OAuth Redirect URL** from AwazIndia to **Redirect URL** field.
...
10. Copy the **Client secret 1** value to the `Client Secret` field on AwazIndia.
11. Start using Xero integration with AwazIndia!
