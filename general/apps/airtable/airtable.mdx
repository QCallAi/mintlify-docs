...
4. Copy **OAuth Redirect URL** from AwazIndia to **OAuth redirect URL** field.
...
9. Copy **Client ID** to **Client ID** field on AwazIndia.
10. Copy **Client secret** to **Client secret** field on AwazIndia.
